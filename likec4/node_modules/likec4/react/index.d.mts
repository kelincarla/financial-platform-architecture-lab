...
import { BBox as BBox_3 } from '@likec4/core/geometry';
...
import { Context as Context_5 } from 'react';
...
import { DynamicViewFlow } from '@likec4/core/types';
import { Edge } from '@xyflow/react';
import { EdgeChange } from '@xyflow/react';
import { EdgeChange as EdgeChange_2 } from '@xyflow/system';
import { EdgeId } from '@likec4/core';
import { EdgeId as EdgeId_2 } from '@likec4/core/types';
...
import { NodeChange as NodeChange_2 } from '@xyflow/system';
...
declare const _actorLogic: StateMachine<Context_4, Events_4, {}, never, never, {
    type: "was opened on hover";
    params: unknown;
} | {
    type: "has search query";
    params: unknown;
} | {
    type: "search query is empty";
    params: unknown;
}, "open timeout" | "close timeout", "pending" | "idle" | {
    active: "search" | "opened" | "decide" | "closing";
}, "active", Input_3, NonReducibleUnknown, EventObject, MetaObject, {
    id: "navigationPanel";
    states: {
        readonly idle: {
            id: "idle";
...
declare const actors_2: {
    hotkey: HotkeyActorLogic_2;
    applyLatest: PromiseActorLogic<EditorCalls.ApplyLatestToManual.Output, EditorCalls.ApplyLatestToManual.Input, EventObject>;
    executeChange: PromiseActorLogic<EditorCalls.ExecuteChange.Output, EditorCalls.ExecuteChange.Input, EventObject>;
    applySemanticLayout: PromiseActorLogic<EditorCalls.ApplySemanticLayout.Output, EditorCalls.ApplySemanticLayout.Input, EventObject>;
};
 ...
 */
declare interface BaseDiagramMachineLogic<Actors extends Partial<ActorLogicMap> = ActorLogicMap, State extends StateValue = never> extends StateMachine<DiagramContext, DiagramEvents, Actors & Omit<ActorLogicMap, keyof Actors>, ChildrenActor, never, never, never, State, never, Input_4, never, DiagramEmittedEvents, never, never> {
}
 ...
 */
declare interface BaseEditorActorLogic<State extends StateValue = any> extends StateMachine<EditorActorContext, EditorActorEvent, inferChildrenRef<typeof actors_2>, inferProvidedActor<typeof actors_2>, never, never, never, State, EditorActorStateTag, EditorActorInput, never, EditorActorEmitedEvent, never, never> {
}

declare type BaseEditorActorRef = ActorRefFromLogic<BaseEditorActorLogic>;
...
declare type ChildrenActors = typeof actors;
...
export declare function CompoundActionButton({ selected, data: { hovered: isHovered, }, icon, ariaLabel, onClick, }: CompoundActionButtonProps): JSX.Element;
...
export declare function CompoundDetailsButton({ selected, data: { hovered: isHovered, }, icon, ariaLabel, onClick, }: CompoundDetailsButtonProps): JSX.Element;
...
export declare function CompoundTitle({ data, 'aria-hidden': ariaHidden }: CompoundTitleProps): JSX.Element;
...
declare function Context_4({ input }: {
    input: Input_3;
}): Context_4;

declare interface Context_4 {
    view: LayoutedView;
...
export declare type DiagramActorSnapshot = SnapshotFrom<DiagramMachineLogic>;

export declare class DiagramApi<A extends Any_3 = Unknown_2> {
    private static cache;
    static withActor(actorRef: RefObject<DiagramActorRef>): DiagramApi;
    /**
     ...
     */
    openSource(params: OpenSourceParams<Unknown_2>): void;
    /**
    ...
    walkthroughStep(value?: 'next' | 'prev' | {
        step: t.StepPath;
    }): void;
...
export declare function DiagramContext({ input }: {
    input: Input_4;
}): DiagramContext;

export declare interface DiagramContext extends Input_4 {
    xynodes: Types.Node[];
    xyedges: Types.Edge[];
...
export declare type DiagramEvents = HotKeyEvent | MediaPrintEvent | {
    ...
    edges?: EdgeChange_2<Types.Edge>[];
    nodes?: NodeChange_2<Types.Node>[];
} | {
    ...
    type: 'update.inputs';
    inputs: Partial<Omit<Input_4, 'view' | 'xystore' | 'dynamicViewVariant' | 'features'>>;
} | {
    ...
    type: 'sequence.flow.collapse';
    flowId: StepPath;
} | {
    type: 'sequence.flow.expand';
    flowId: StepPath;
} | {
    type: 'sequence.flow.toggle';
    flowId: StepPath;
} | {
...
declare const _diagramMachine: StateMachine<DiagramContext, DiagramEvents, {
    search?: ActorRefFromLogic<SearchActorLogic>;
    hotkey?: ActorRefFromLogic<HotkeyActorLogic>;
    overlays?: ActorRefFromLogic<OverlaysActorLogic>;
    mediaPrint?: ActorRefFromLogic<MediaPrintActorLogic>;
    editor?: ActorRefFromLogic<EditorActorLogic>;
    navigationPanel?: ActorRefFromLogic<NavigationPanelActorLogic>;
}, {
    src: "search";
    logic: SearchActorLogic;
    id: "search";
} | {
    src: "hotkey";
    ...
    src: "overlays";
    logic: OverlaysActorLogic;
    id: "overlays";
} | {
    src: "mediaPrint";
    logic: MediaPrintActorLogic;
    id: "mediaPrint";
} | {
    src: "editor";
    logic: EditorActorLogic;
    id: "editor";
} | {
    src: "navigationPanel";
    logic: NavigationPanelActorLogic;
    id: "navigationPanel";
}, never, {
    type: "isReady";
    params: unknown;
    ...
    type: "is dynamic view in sequence variant";
    params: unknown;
} | {
    type: "is same view";
    params: unknown;
    ...
    type: "click: node.type = seq-subflow";
    params: unknown;
} | {
    ...
    params: unknown;
}, never, "final" | "isReady" | "navigating" | "initializing" | {
    ready: "idle" | "walkthrough" | "focused" | "printing";
}, string, Input_4, NonReducibleUnknown, DiagramEmittedEvents, MetaObject, {
    states: {
...
declare interface DiagramMachineLogic extends BaseDiagramMachineLogic<{
...
declare interface EditorActorLogic extends BaseEditorActorLogic {
}
...
declare namespace EditorCalls {
    ...
    type ApplySemanticLayout = (params: {
        input: ApplySemanticLayout.Input;
    }) => Promise<ApplySemanticLayout.Output>;
    namespace ApplySemanticLayout {
        type Input = {
            viewId: t.ViewId;
        };
        type Output = {};
 ...
 * ```
 */
export declare function ElementData({ data, 'aria-hidden': ariaHidden }: ElementDataProps & {
    'aria-hidden'?: boolean | undefined;
}): JSX.Element;
...
export declare function ElementDetailsButton({ selected, data: { hovered: isHovered, }, icon, ariaLabel, onClick, }: ElementDetailsButtonProps): JSX.Element;
...
declare type ElementDetailsInput = {
    subject: Fqn;
    currentView: DiagramView;
    initiatedFrom?: {
        node?: NodeId;
...
}, any, any, any, any, any, never, ElementDetailsInput, any, any, any, any> {
}
...
export declare function ErrorBoundary(props: Pick<ErrorBoundaryProps, 'onReset' | 'onError' | 'children'>): JSX.Element;
...
export declare function ErrorFallback({ error, resetErrorBoundary }: FallbackProps): JSX.Element;
...
declare interface HotkeyActorLogic extends CallbackActorLogic<AnyEventObject, NonReducibleUnknown, HotKeyEvent> {
}

declare interface HotkeyActorLogic_2 extends CallbackActorLogic<AnyEventObject, NonReducibleUnknown, HotKeyEvent_2> {
}
...
declare type inferChildrenRef<A> = A extends Record<string, AnyActorLogic> ? {
    [K in keyof A & string]: ActorRefFromLogic<A[K]> | undefined;
} : never;

declare type inferProvidedActor<A> = A extends Record<string, AnyActorLogic> ? {
    [K in keyof A & string]: {
        id: K;
        logic: A[K];
        src: K;
    };
}[keyof A & string] : never;
...
declare type Input_2 = ExclusiveUnion_2<{
    Edge: {
        edgeId: EdgeId;
        viewId: ViewId_3;
    };
...
declare interface Input_3 {
    view: LayoutedView;
    viewModel: CurrentViewModel | null;
}

declare interface Input_4 {
    view: DiagramView;
    xystore: XYStoreApi_3;
    zoomable: boolean;
    pannable: boolean;
...
declare interface MediaPrintActorLogic extends CallbackActorLogic<AnyEventObject, NonReducibleUnknown, MediaPrintEvent> {
}
...
declare interface NavigationPanelActorLogic extends StateMachine<Context_4, Events_4, any, any, any, any, any, StateValueFrom<typeof _actorLogic>, Tags_3, Input_3, any, any, any, any> {
}

declare interface NavigationPanelActorRef extends ActorRef<NavigationPanelActorSnapshot, Events_4, never> {
}

declare type NavigationPanelActorSnapshot = SnapshotFrom<NavigationPanelActorLogic>;
 ...
 */
export declare function pickViewBounds(view: LayoutedView, dynamicVariant?: DynamicViewDisplayVariant): BBox_3;
...
declare interface Readable<T> extends Subscribable<T> {
    get: () => T;
}
...
declare interface RelationshipDetailsLogic extends StateMachine<Context_3, Events_3, {}, any, any, any, any, any, Tags_2, Input_2, any, any, any, any> {
}
...
declare interface RelationshipsBrowserLogic extends StateMachine<Context_2, Events_2, {}, any, any, any, any, any, Tags, Input, any, any, any, any> {
}
...
export declare const SearchContext: Context_5<SearchContextValue | null>;
 ...
 */
declare type SelectAndCompare<A, B> = [
selector: (snapshot: A) => B,
compare: (a: B, b: B) => boolean
];

export declare const selectDiagramContext: <T>(select: (state: DiagramContext) => T, compare?: ((old: NoInfer<T>, next: NoInfer<T>) => boolean) | undefined) => SelectAndCompare< MachineSnapshot<DiagramContext, DiagramEvents, {
    overlays: OverlaysActorRef | undefined;
    search: SearchActorRef | undefined;
    editor: BaseEditorActorRef | undefined;
    navigationPanel: NavigationPanelActorRef | undefined;
} & Omit<{
    hotkey: ActorRefFromLogic<HotkeyActorLogic> | undefined;
    overlays: ActorRefFromLogic<OverlaysActorLogic> | undefined;
    search: ActorRefFromLogic<SearchActorLogic> | undefined;
    mediaPrint: ActorRefFromLogic<MediaPrintActorLogic> | undefined;
    editor: ActorRefFromLogic<EditorActorLogic> | undefined;
    navigationPanel: ActorRefFromLogic<NavigationPanelActorLogic> | undefined;
}, "search" | "overlays" | "editor" | "navigationPanel">, "final" | "isReady" | "navigating" | "ready" | "initializing" | {
    ready?: NonNullable<"idle" | "walkthrough" | "focused" | "printing">;
}, never, never, never, never>, T>;

export declare const selectDiagramSnapshot: <T>(select: (state: MachineSnapshot<DiagramContext, DiagramEvents, {
    overlays: OverlaysActorRef | undefined;
    search: SearchActorRef | undefined;
    editor: BaseEditorActorRef | undefined;
    navigationPanel: NavigationPanelActorRef | undefined;
    ...
    ready?: NonNullable<"idle" | "walkthrough" | "focused" | "printing">;
}, never, never, never, never>) => T, compare?: ((old: NoInfer<T>, next: NoInfer<T>) => boolean) | undefined) => SelectAndCompare< MachineSnapshot<DiagramContext, DiagramEvents, {
    overlays: OverlaysActorRef | undefined;
    search: SearchActorRef | undefined;
    editor: BaseEditorActorRef | undefined;
    navigationPanel: NavigationPanelActorRef | undefined;
...
declare function setData<E extends WithData<any>>(value: E, data: Partial<E['data']>): E;
...
declare type StateFrom<T extends AnyStateMachine | ((...args: any[]) => AnyStateMachine)> = T extends AnyStateMachine ? ReturnType<T['transition']> : T extends (...args: any[]) => AnyStateMachine ? ReturnType<ReturnType<T>['transition']> : never;
...
declare type StateValueFrom<TMachine extends AnyStateMachine> = Parameters<StateFrom<TMachine>['matches']>[0];
...
export declare namespace Types {
     ...
     */
    export type SequenceSubflowData = LeafNodeData & {
        flowId: StepPath;
    ...
    export type AnyNode = ElementNode | DeploymentElementNode | CompoundElementNode | CompoundDeploymentNode | ViewGroupNode | SequenceActorNode | SequenceParallelArea | SequenceSubflowArea;
    ...
    export type SequenceStepEdgeData = Simplify<BaseEdgeData & NonOptional<Pick<DiagramEdge, 'label' | 'technology' | 'points' | 'dir' | 'color' | 'line' | 'head' | 'tail' | 'navigateTo' | 'astPath' | 'drifts'>> & {
        id: StepPath;
...
export declare const useDiagramActorRef: () => DiagramActorRef;
...
export declare const useDiagramSelector: {
    <T>(select: (state: MachineSnapshot<DiagramContext, DiagramEvents, {
        overlays: OverlaysActorRef | undefined;
        search: SearchActorRef | undefined;
        editor: BaseEditorActorRef | undefined;
        navigationPanel: NavigationPanelActorRef | undefined;
        ...
        ready?: NonNullable<"idle" | "walkthrough" | "focused" | "printing">;
    }, never, never, never, never>) => T): T;
    <T>(selectorCompare: SelectAndCompare< MachineSnapshot<DiagramContext, DiagramEvents, {
        overlays: OverlaysActorRef | undefined;
        search: SearchActorRef | undefined;
        editor: BaseEditorActorRef | undefined;
        navigationPanel: NavigationPanelActorRef | undefined;
    ...
    <T>(selector: (snapshot: MachineSnapshot<DiagramContext, DiagramEvents, {
        overlays: OverlaysActorRef | undefined;
        search: SearchActorRef | undefined;
        editor: BaseEditorActorRef | undefined;
        navigationPanel: NavigationPanelActorRef | undefined;
        ...
        ready?: NonNullable<"idle" | "walkthrough" | "focused" | "printing">;
    }, never, never, never, never>) => T, compare: (a: T, b: T) => boolean): T;
};
