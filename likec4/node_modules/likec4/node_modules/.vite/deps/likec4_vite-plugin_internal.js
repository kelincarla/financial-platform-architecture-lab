...
import { m as Y } from "./model-DBSABTjR.js";
import "./@likec4_core_model.js";
...
function createHooksForModel($atom) {
	const $likec4model = /* @__PURE__ */ computed($atom, (data) => Y.create(data));
	...
	function useLikeC4View(viewId) {
		return useStore((0, import_react.useMemo)(() => /* @__PURE__ */ computed($likec4model, (model) => model.findView(viewId)?.$layouted ?? null), [viewId]));
	}
	return {
		updateModel,
		$likec4model,
