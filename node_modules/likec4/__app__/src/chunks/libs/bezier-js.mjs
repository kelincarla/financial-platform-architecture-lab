...
var c = Math.PI, l = 2 * c, u = c / 2, f = 1e-6, p = 2 ** 53 - 1 || 9007199254740991, m = -(2 ** 53 - 1) || -9007199254740991, h = {
	...
	static quadraticFromPoints(e, n, r, i) {
		if (i === void 0 && (i = .5), i === 0) return new Bezier(n, n, r);
		if (i === 1) return new Bezier(e, n, n);
		let a = Bezier.getABC(2, e, n, r, i);
		return new Bezier(e, a.A, r);
	}
	...
	offset(e, n) {
		...
		if (this._linear) {
			let n = this.normal(0), r = this.points.map(function(r) {
				let i = {
					x: r.x + e * n.x,
					y: r.y + e * n.y
				};
