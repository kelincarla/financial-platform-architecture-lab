...
var RouterCore = class {
	constructor(e) {
		...
		}) : e._lazyPromise = Promise.resolve()), e._componentsPromise === void 0 && (e._componentsPromise = e._lazyPromise.then(() => Promise.all(D.map(async (t) => {
			let n = e.options[t];
...
//#endregion
export { createBrowserHistory as _, P as a, Navigate as c, useParams as d, useRouter as f, notFound as g, isNotFound as h, useMatches as i, useNavigate as l, redirect as m, createRouter as n, createFileRoute as o, stripSearchParams as p, I as r, createRootRouteWithContext as s, RouterProvider as t, useSearch as u, createHashHistory as v };
